...
const About = () => {
     ...
     const socials = [
          { icon: <FaLinkedin className="text-xl" />, link: "https://www.linkedin.com/in/mustafa-tazwer/" },
               ...
               <div className="grid grid-cols-1 xl:grid-cols-2 gap-16 items-center ">
                    ...
                    >
                         ...
                         <div className="mt-10 text-center">
                              <h2 className="text-3xl lg:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-400/95 font-bold mb-2 ">Mustafa Tazwer Shakil</h2>
